		...
		<div className="bg-gray-100">
			<div className="flex flex-wrap w-10/12 m-auto p-8">
				<div className="md:w-1/2 lg:w-1/4 text-center p-2">
					...
					<h2 className="text-slate-800 font-bold text-xl m-2">ISBN</h2>
				...
				<div className="md:w-1/2 lg:w-1/4 text-center p-2">
					...
					<h2 className="text-slate-800 font-bold text-xl m-2">Pages</h2>
					{/* <p className="text-sm mx-2 mb-2 md:p-2 text-slate-400">
				...
				<div className="md:w-1/2 lg:w-1/4 text-center p-2">
					...
					<h2 className="text-slate-800 font-bold text-xl m-2">Published</h2>
					{/* <p className="text-sm mx-2 mb-2 md:p-2 text-slate-400">
				...
				<div className="md:w-1/2 lg:w-1/4 text-center p-2">
					...
					<h2 className="text-slate-800 font-bold text-xl m-2">Inventory</h2>
					{/* <p className="text-sm mx-2 mb-2 md:p-2 text-slate-400">
