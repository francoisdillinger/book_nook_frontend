        ...
        <nav className="bg-gray-100">
            <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="hidden md:flex items-center w-1/2">
                        ...
                        <div className="flex min-w-full">
                            ...
                            <div className="relative w-full">
                                <input type="search" id="search-dropdown" className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50  border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 focus-visible:outline-none" placeholder="Search by Author or Titles..." required />

                            </div>
                            <button type="submit" className="p-2.5 z-10 text-sm font-medium h-full text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Search
                            </button>
                        </div>
                    </div>
                    <div className="hidden md:flex justify-end w-40 items-center space-x-1 ">
                        {loggedIn?
                            <React.Fragment>
                                ...
                                <div className="relative">
                                    <div ref={profileRef} id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider">
                                        <img className="w-7 h-7 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src="" alt="Bordered avatar"/>
                                    </div>

                                    {dropDownState.show && (
                                        <div ref={dropDownRef} id="dropdownDivider" className={`z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 absolute top-full mt-2 right-0`}>
                                            {/* Dropdown items */}
                                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDividerButton">
                                                ...
                                                <li onClick={() => {setLoggedIn(false); dropDownDispatch({ type: 'navigating'})}}>
                                                    <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline">
                ...
                <div className={`${state.hidden ? 'max-h-0' : 'max-h-[500px]'} overflow-hidden transition-all ease-in-out duration-300`} ref={navRef}>
                    <div className={`${state.hidden ? 'opacity-0 translate-y-[-100%]' : 'opacity-100 translate-y-0'} transform transition-all ease-in-out duration-600`}>
