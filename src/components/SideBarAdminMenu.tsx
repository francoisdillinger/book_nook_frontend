...
export default function SideBarAdminMenu(){
    ...
    return(
        <div className="relative">
            <div className={`bg-slate-200 shadow-md min-h-screen w-72 absolute transition ease-in-out transform ${close ? 'translate-x-0' : '-translate-x-56'}`}>
                <div className='flex justify-between pr-2 items-center'>
                    ...
                    <button className="shadow-md rounded-full active:shadow-none" onClick={() => setClose(!close)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} className={`stroke-logo w-12 h-12 cursor-pointer transition ease-in-out ${close ? 'rotate-0' : 'rotate-180'}`}>
                ...
                <div className='flex justify-between px-2 items-center my-2'>
                    ...
                    <button className='shadow-md rounded-md active:shadow-none'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} className="stroke-logo w-12 h-12">
