...
export default function RecommendedBookDetails({ index, counter, book }: RecomendedBookDetailProps) {
    ...
    return (
      <div className={`text-center ${opacityClass} transition-opacity duration-300`}>
        <h3 className='text-2xl font-bold text-slate-900 mt-6 mb-2'>{book.title}</h3>
        ...
        <button className='w-4/5 rounded-md p-2 my-2 bg-amber-500 hover:scale-110 active:scale-95 duration-300'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline-block text-white mr-2">
